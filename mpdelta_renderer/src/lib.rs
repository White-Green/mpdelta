...
#[derive(Error)]
pub enum EvaluateError<K: 'static, T: ParameterValueType> {
...
impl<K, T: ParameterValueType> Debug for EvaluateError<K, T> {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
...
impl<K, T: ParameterValueType> Clone for EvaluateError<K, T> {
    fn clone(&self) -> Self {
        match self {
...
struct EvaluateComponent<K: 'static, T: ParameterValueType, ImageCombinerBuilder, AudioCombinerBuilder, Id> {
    _phantom: PhantomData<(K, T, ImageCombinerBuilder, AudioCombinerBuilder, Id)>,
}
// struct EvaluateComponent<K: 'static, T: ParameterValueType, ImageCombinerBuilder, AudioCombinerBuilder, Id> {
